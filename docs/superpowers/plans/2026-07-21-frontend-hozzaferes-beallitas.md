...
Expected: a legördülő piros keretet kap, alatta a szöveg: „Ezt az oldalt publikusnak is be kell pipálnod, különben az új jelentkezők nem érik el a regisztrációs oldalt." A beállítás **nem** mentődik el.
