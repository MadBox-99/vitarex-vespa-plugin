...
Class DuplicatePost
{
    ...
    public function duplicatePostAsDraft()
    {
        ...
        if ( isset( $post ) && $post != null ) {
            ...
            $sqlpostMetaInfos = "SELECT meta_key, meta_value FROM $wpdb->postmeta WHERE post_id=$postId";
            $postMetaInfos = $wpdb->get_results($wpdb->prepare($sqlpostMetaInfos, $postId));
